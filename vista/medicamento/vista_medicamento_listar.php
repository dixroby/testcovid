        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" style="text-align:center;"><b>Registro De Medicamentos</b></h4>
                </div>
                <div class="modal-body">
                    <div class="col-lg-12">
                        <label for="">Nombre</label>
                        <input type="text" class="form-control" id="txt_medicamento" placeholder="Ingrese Medicamento" maxlength="250" ><br>
                    </div>
                    <div class="col-lg-12">
                        <label for="">Alias</label>
                        <input type="text" class="form-control" id="txt_medicamentoalias" placeholder="Ingrese Alias" maxlength="250" "><br>
                    </div>
                    <div class="col-lg-12">
                ...
                <div class="modal-footer">
                    <button class="btn btn-primary" onclick="Registrar_Medicamento()"><i
    ...
    <div class="modal fade" id="modal_editar" role="dialog">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title" style="text-align:center;"><b>Actualizar Medicamentos</b></h4>
                </div>
                <div class="modal-body">
                    <div class="col-lg-12">
                        <label for="">Nombre</label>
                        <input type="text" id="txtidmedicamento" hidden>
                        <input type="text" class="form-control" id="txt_medicamento_editar" placeholder="Ingrese Medicamento" maxlength="250" ><br>
                    </div>
                    <div class="col-lg-12">
                        <label for="">Alias</label>
                        <input type="text" class="form-control" id="txt_medicamentoalias_editar" placeholder="Ingrese Alias" maxlength="250" "><br>
                    </div>
                    <div class="col-lg-12">
                        <label for="">Stock</label>
                ...
                <div class="modal-footer">
                    <button class="btn btn-primary" onclick="Modificar_Medicamento()"><i
                            class="fa fa-check"><b>&nbsp;Registrar</b></i></button>
                    <button type="button" class="btn btn-danger" data-dismiss="modal"><i
                            class="fa fa-close"><b>&nbsp;Cerrar</b></i></button>
                </div>

<script type="text/javascript" src="../js/pacientes.js?rev=<?php echo time();?>"></script>
<div class="col-md-12">
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" style="text-align:center;"><b>Registro De Pacientes</b></h4>
                </div>
                <div class="modal-body">
                    ...
                    <div class="col-lg-12">
                        ...
                        <input type="text" class="form-control" id="txt_telefono" placeholder="Ingrese Telefono" maxlength="5" onkeypress="return soloNumeros(event)"><br>
                    </div>
                    <div class="col-lg-12">
    ...
    <div class="modal fade" id="modal_editar" role="dialog">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title" style="text-align:center;"><b>Actualizar Paciente</b></h4>
                </div>
                <div class="modal-body">
                    <div class="col-lg-12">
                        <label for="">DNI</label>
                        <input type="text" id="txtidinsumo" hidden>
                        <input disabled type="text" class="form-control" id="txt_dni_editar" placeholder="Ingrese DNI" maxlength="8" onkeypress="return soloNumeros(event)"><br>
                    </div>
                    <div class="col-lg-12">
                        <label for="">Nombre</label>
                    ...
                    <div class="col-lg-12">
                        <label for="">Telefono</label>
                        <input type="text" class="form-control" id="txt_telefono_editar" placeholder="Ingrese Telefono" maxlength="5" onkeypress="return soloNumeros(event)"><br>
                    </div>
                    <div class="col-lg-12">
                        <label for="">Sexo</label>

...
<body>
    ...
    <div class="jumbotron">
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <center>
                    <h1>Podrias estar en riesgo de adquirir la enfermedad</h1>
                </center>
                ...
                <div class="row">
                    <div class="col-sm-7 col-md-12">
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                <p>Debido a que solo tienes un sintoma o ninguno, podrias estar en
                                    riesgo de desarrollar la enfermedad si no tienes los cuidados
                                    adecuados.
                                    Debes estar atento a la aparición de sintomas adicionales (tos,
                                    dolor de garganta, dificultad para respirar, congestionn nasal, fiebre)</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-7 col-md-12">

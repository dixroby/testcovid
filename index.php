...
<nav  class="navbar navbar-inverse fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a asp-area="" asp-controller="Home" asp-action="Index" class="navbar-brand">Unamba</a>
            </div>
                                ...
                                <div class="caption">
                                    <div class="form-group">
                                        ...
                                        <input value="47556211" type="text" class="form-control" maxlength="8"
                                            onkeypress="return solonumeros(event)" onpaste="return false" id="txt_Dni"
                                            name="txtDni" placeholder="escriba su dni" pattern="[0-9]{8}" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="">Ingrese codigo</label>
                                        <input type="text" value="051005" class="form-control" maxlength="6"
                                            onkeypress="return solonumeros(event)" id="txt_Codigo"
                                            onpaste="return false" name="txtCodigo" placeholder="escriba su codigo"
                                            pattern="[0-9]{8}" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="">Ingrese codigo</label>
                                        <input id="tx_tTelefono" type="text" class="form-control" maxlength="6"
                                            onkeypress="return solonumeros(event)" onpaste="return false"
                                            name="txtCodigo" placeholder="escriba su codigo" pattern="[0-9]{8}"
                                            required>
                                    </div>

                                    <p><a class="btn btn-primary btn-lg" onclick="VerificarEstudiante()"
                                            role="button">Empezar
                                            Evaluación</a></p>
                                </div>
                            </div>

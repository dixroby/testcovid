            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="col-lg-12">
                        ...
                        <input type="text" class="form-control" id="txt_especialidad" placeholder="Ingrese Especialidad" maxlength="240"><br>
                    </div>
                    <div class="col-lg-12">
    ...
    <div class="modal fade" id="modal_editar" role="dialog">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title" style="text-align:center;"><b>Actualizar Especialidad</b></h4>
                </div>
                <div class="modal-body">
                    <div class="col-lg-12">
                        <label for="">Nombre</label>
                        
                        <input type="text" class="form-control" id="txt_especialidad_editar" placeholder="Ingrese Especialidad" maxlength="240"><br>
                ...
                <div class="modal-footer">
                    <button class="btn btn-primary" onclick="Modificar_Especialidad()"><i
